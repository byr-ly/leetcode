...
public class PersonalTailorHotTool extends BaseDriver {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "personalTailorHot2hbase");
		job.setJarByClass(PersonalTailorHotTool.class);
		job.setMapperClass(PersonalTailorHotMapper.class);
		job.setReducerClass(PersonalTailorHotReducer.class);
