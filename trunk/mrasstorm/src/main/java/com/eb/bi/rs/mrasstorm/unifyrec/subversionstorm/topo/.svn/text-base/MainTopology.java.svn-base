package com.eb.bi.rs.mrasstorm.unifyrec.subversionstorm.topo;
...
import com.eb.bi.rs.mrasstorm.unifyrec.subversionstorm.bolt.MergeVersionBolt;
import com.eb.bi.rs.mrasstorm.unifyrec.subversionstorm.bolt.RequestSpout;
import com.eb.bi.rs.mrasstorm.unifyrec.subversionstorm.bolt.SimilarBolt;
...
/**
 * @author ynn
 * @date 创建时间：2016-3-30 上午10:16:34
 * @version 1.0
 */
public class MainTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		String topoName = pluginConfig.getParam("topo_name", "unifyrec-realtimerec-subversion-topology");
		...
		builder.setBolt("merge-bolt", new MergeVersionBolt(), boltNum)
