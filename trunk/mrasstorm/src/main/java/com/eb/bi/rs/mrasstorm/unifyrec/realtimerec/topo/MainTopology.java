package com.eb.bi.rs.mrasstorm.unifyrec.realtimerec.topo;
...
import com.eb.bi.rs.mrasstorm.unifyrec.realtimerec.bolt.MergeBoltB;
import com.eb.bi.rs.mrasstorm.unifyrec.realtimerec.bolt.MergeBoltSimilar;
import com.eb.bi.rs.mrasstorm.unifyrec.realtimerec.bolt.RequestSpout;
import com.eb.bi.rs.mrasstorm.unifyrec.realtimerec.bolt.SimilarBolt;
...
public class MainTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		String topoName = pluginConfig.getParam("topo_name", "unifyrec-realtimerec-topology");
		...
		builder.setBolt("merge-bolt", new MergeBoltSimilar(), boltNum)
				.shuffleGrouping("similar-bolt", "MergeBoltA");
		builder.setBolt("merge-bolt-B", new MergeBoltB(), boltNum)
		.shuffleGrouping("similar-bolt", "MergeBoltB");
