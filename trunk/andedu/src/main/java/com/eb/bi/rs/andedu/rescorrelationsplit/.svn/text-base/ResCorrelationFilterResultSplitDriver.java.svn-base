...
public class ResCorrelationFilterResultSplitDriver extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		String fieldsDelimiter = config.getParam("fields_delimiter", ";");
		
		conf = new Configuration(getConf());
		conf.set("fields.delimiter", fieldsDelimiter);
		job = new Job(conf, "ResourceCorrelationRecResultSplitDriver");
		...
		job.setMapperClass(ResCorrelationFilterResultSplitMapper.class);
	...
	public static void main( String[] args ) throws Exception { 	
		...
		int ret = ToolRunner.run(new ResCorrelationFilterResultSplitDriver(), args);	
