 ...
 */
public class GetKeyWordInfosDriver extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        PluginUtil.getInstance().init(args);
        Logger log = PluginUtil.getInstance().getLogger();
        Date dateBeg = new Date();

        int ret = ToolRunner.run(new GetKeyWordInfosDriver(), args);
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setJarByClass(GetKeyWordInfosDriver.class);
