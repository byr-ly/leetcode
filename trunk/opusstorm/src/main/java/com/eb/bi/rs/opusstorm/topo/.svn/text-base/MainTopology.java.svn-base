package com.eb.bi.rs.opusstorm.topo;
...
import com.eb.bi.rs.opusstorm.bolt.HandleResultBolt;
import com.eb.bi.rs.opusstorm.spout.RequestSpout;
...
public class MainTopology {
	...
	public static void main(String[] args) throws Exception  {
		...
		builder.setBolt("handle-bolt", new HandleResultBolt(), boltNum)
		...
		try {
			StormSubmitter.submitTopology("opusstorm-topology", conf,
