...
import com.eb.bi.rs.mras.unifyrec.attributeengin.UserPrefAverage.UserPrefAverageMapper;
import com.eb.bi.rs.mras.unifyrec.attributeengin.UserPrefAverage.UserPrefAverageReducer;
...
import com.eb.bi.rs.mras.unifyrec.attributeengin.UserReadClasses.UserReadClassesDriver;
...
public class BookPrefEngineWeek extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        Job job = new Job(conf, "unifyrec_prefengine_user-pref-average");
        ...
        job = new Job(conf, "unifyrec_prefengine_user-pref-generator");
        job.setJarByClass(BookPrefEngineWeek.class);
        ...
        job = new Job(conf, "unifyrec_prefengine_user-read-classes");
        ...
        job = new Job(conf, "unifyrec_prefengine_user-read-history");
        job.setJarByClass(BookPrefEngineWeek.class);
        ...
        job = new Job(conf,"unifyrec_prefengine_user-class-pref");
        ...
        job = new Job(conf, "unifyrec_prefengine_force-rec-class-pref");
        job.setJarByClass(BookPrefEngineWeek.class);
        ...
        job = new Job(conf, "unifyrec_prefengine_comprehensive-pref-recommend");
        ...
        job = new Job(conf, "unifyrec_prefengine_man-pref-recommend");
        job.setJarByClass(BookPrefEngineDay.class);
        ...
        job = new Job(conf, "unifyrec_prefengine_female-pref-recommend");
        job.setJarByClass(BookPrefEngineDay.class);
        ...
        job = new Job(conf, "unifyrec_prefengine_publish-pref-recommend");
        job.setJarByClass(BookPrefEngineDay.class);
        ...
        job = new Job(conf, "unifyrec_prefengine_prefrec-result-merge");
        job.setJarByClass(BookPrefEngineDay.class);
