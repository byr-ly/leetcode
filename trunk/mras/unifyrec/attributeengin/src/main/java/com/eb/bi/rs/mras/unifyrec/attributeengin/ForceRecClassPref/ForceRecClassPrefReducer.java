package com.eb.bi.rs.mras.unifyrec.attributeengin.ForceRecClassPref;
...
public class ForceRecClassPrefReducer extends Reducer<Text, Text, Text, NullWritable> {
    ...
    protected void setup(Context context) throws IOException {
        ...
        for (int i = 0; i < localFiles.length; i++) {
            ...
            } else if (fileName.contains("female")) {
                while ((line = br.readLine()) != null) {
                	String [] fields =line.split("\\|", -1);
                    String bookId = fields[0];
                    String classId = fields[1];
            ...
            }else if (fileName.contains("publish")) {
                while ((line = br.readLine()) != null) {
                	String [] fields =line.split("\\|", -1);
                    String bookId = fields[0];
                    String classId = fields[1];
