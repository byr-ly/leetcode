...
public class FormatConvertSimDriver extends BaseDriver {

	@Override
	public int run(String[] args) throws Exception {
		// TODO Auto-generated method stub
		Logger log = Logger.getLogger("FormatConvertSimDriver");
		...
		//--------------------------------------------------------
		job = new Job(conf);
		job.setJarByClass(FormatConvertSimDriver.class);
...
//		job.setOutputFormatClass(TextOutputFormat.class);
	...
	public static class SimMapper extends Mapper<NullWritable, Text, Text, Text> {
		@Override
		protected void map(NullWritable key, Text value, Context ctx) 
			...
			ctx.write(new Text(fields[0]), new Text(fields[1]+"|"+fields[2]));
		}
	}
