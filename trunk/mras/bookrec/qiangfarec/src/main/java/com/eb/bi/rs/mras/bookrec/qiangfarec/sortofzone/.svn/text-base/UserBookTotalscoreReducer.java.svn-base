...
public class UserBookTotalscoreReducer extends Reducer<Text, Text, NullWritable, Text> {
	...
	protected void reduce(Text key, Iterable<Text> values, Context context)
		...
		while (it.hasNext()) {
			...
			Iterator<Map.Entry<String, Double>> iterator = bookIDsPoints.entrySet().iterator();
...
//			}
	        ...
	        //图书总分排序  
	        List<Map.Entry<String, Double>> list = new ArrayList<Map.Entry<String, Double>>(resultScore.entrySet());  
