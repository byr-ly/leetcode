...
import com.eb.bi.rs.mras.bookrec.corelationrec.Browse.BrowseCorelationBookRecReducer;
import com.eb.bi.rs.mras.bookrec.corelationrec.Browse.BrowseRecForBookWithoutCooccurrenceInfoReducer;
...
public class BrowseCorelationRecDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		conf.setInt("deep.read.threshold", config.getParam("browse_deep_read_threshold", 100));	
		...
		conf.setFloat("first.lower.bound",  config.getParam("first_lower_bound", 0.15f));
		conf.setFloat("first.upper.bound",  config.getParam("first_upper_bound", 0.65f));		
		conf.set("book.series.path", bookSeriesPath);
