package com.eb.bi.rs.mras.generec.storm.topo;
...
import com.eb.bi.rs.mras.generec.storm.bolt.ActionBolt;
import com.eb.bi.rs.mras.generec.storm.bolt.MergeBoltSimilar;
import com.eb.bi.rs.mras.generec.storm.bolt.RequestSpout;
import com.eb.bi.rs.mras.generec.storm.bolt.SimilarBolt;
...
/**分类权重A
 * Created by linwanying on 2017/4/5.
 */
public class ClassiftweightATopo {
    public static void main(String[] args) throws Exception {
        ...
        try {
            StormSubmitter.submitTopology("classifyweight-A-topology",
