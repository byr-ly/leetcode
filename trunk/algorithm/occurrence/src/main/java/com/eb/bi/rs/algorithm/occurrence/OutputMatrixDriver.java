...
public class OutputMatrixDriver extends Configured  implements Tool{
	...
	public OutputMatrixDriver(Logger log,String inputPath, String outputPath, Configuration conf, int reduceNum){
		m_log = log;
