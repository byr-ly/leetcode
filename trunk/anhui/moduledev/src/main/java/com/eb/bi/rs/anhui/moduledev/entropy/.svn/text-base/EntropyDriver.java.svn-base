...
public class EntropyDriver extends Configured implements Tool {
    ...
    public EntropyDriver(String[] args) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int ret = ToolRunner.run(new Configuration(), new EntropyDriver(args), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(EntropyDriver.class);
        //M-R
        job.setMapperClass(PeakMapper.class);
        job.setNumReduceTasks(Integer.parseInt(config.getParam("anhui.entropy.reduce.num.peak", "5")));
        ...
        //设置输入地址
        FileInputFormat.setInputPaths(job, new Path(config.getParam("anhui.entropy.originalinfo", "/user/ebupt/linwanying/anhui/entropy/originalinfo")));
        //设置输出地址
        String peakDir = config.getParam("anhui.entropy.peak", "/user/ebupt/linwanying/anhui/entropy/peak");
        ...
        job.setNumReduceTasks(Integer.parseInt(config.getParam("anhui.entropy.reduce.num.standardize", "5")));
        //设置输入/输出格式
        job.setInputFormatClass(TextInputFormat.class);
        job.setOutputFormatClass(TextOutputFormat.class);
        //设置输出类型(map)
        ...
        FileInputFormat.setInputPaths(job, new Path(config.getParam("anhui.entropy.originalinfo", "/user/ebupt/linwanying/anhui/entropy/originalinfo")));
        //设置输出地址
        String standardizeDir = config.getParam("anhui.entropy.standardize", "/user/ebupt/linwanying/anhui/entropy/standardize");
        ...
        job.setNumReduceTasks(Integer.parseInt(config.getParam("anhui.entropy.reduce.num.sum", "5")));
        ...
        //设置输出地址
        String sumDir = config.getParam("anhui.entropy.sum", "/user/ebupt/linwanying/anhui/entropy/sum");
        ...
        //M-R
        job.setMapperClass(SumMapper.class);
        job.setNumReduceTasks(Integer.parseInt(config.getParam("anhui.entropy.reduce.num.entropy", "5")));
        ...
        FileInputFormat.setInputPaths(job, new Path(standardizeDir));
        //设置输出地址
        String entropyDir = config.getParam("anhui.entropy.entropy", "/user/ebupt/linwanying/anhui/entropy/entropy");
        ...
        job.setNumReduceTasks(Integer.parseInt(config.getParam("anhui.entropy.reduce.num.score", "5")));
        ...
        FileInputFormat.setInputPaths(job, new Path(standardizeDir));
        //设置输出地址
        String scoreDir = config.getParam("anhui.entropy.score", "/user/ebupt/linwanying/anhui/entropy/score");
