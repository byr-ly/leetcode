 ...
 */
public class TopSimilarOpusMapper extends Mapper<Object, Text, Text, Text> {

	private float minSimilarity;

	/**
	 * value 格式：源动漫|目的动漫|相似度|共现次数
	 */
	@Override
	protected void map(Object key, Text value, Context context)
		...
		context.write(new Text(fields[1]),
				new Text(fields[0] + "|" + fields[2]));
	}
