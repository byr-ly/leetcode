...
public class CalculateSimilarScoreDriver extends Configured implements Tool {

	private static PluginUtil pluginUtil;
	private static Logger log;

	public CalculateSimilarScoreDriver(String[] args) {
	...
	public static void main(String[] args) throws Exception {
		...
		int ret = ToolRunner.run(new Configuration(),
				new CalculateSimilarScoreDriver(args), args);
	...
	public int run(String[] arg0) throws Exception {
		...
		job.setJarByClass(CalculateSimilarScoreDriver.class);
		...
		FileStatus[] status = fs
				.globStatus(new Path(opusModuleDir + "/part-*"));
