...
public class MergeDataDriver extends BaseDriver{
	...
	public int run(String[] args) throws Exception {
		...
		String duplicateRemovalFields = properties.getProperty("duplicate.removal.fields");
		conf.set("duplicateRemovalFields", duplicateRemovalFields);
		
		String fieldSeparator = properties.getProperty("field.separator");
		conf.set("fieldSeparator", fieldSeparator);
