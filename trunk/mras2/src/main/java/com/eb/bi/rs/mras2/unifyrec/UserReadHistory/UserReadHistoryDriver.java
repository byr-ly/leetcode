//package com.eb.bi.rs.mras2.unifyrec.UserReadHistory;
//
...
// */
//public class UserReadHistoryDriver extends Configured implements Tool {
//
//
...
//
//        int ret = ToolRunner.run(new UserReadHistoryDriver(), args);
...
//
//        String inputPath = config.getParam("user_read_his", "/user/recsys/user_read_history");
//        String outputPath = config.getParam("user_read_history", "/user/hadoop/liujie/test/output/user_read_history");
//
//        System.out.println("输入路径: " + inputPath);
//        System.out.println("输出路径: " + outputPath);
//
//        Job job = new Job(conf, "user-read-history");
//        job.setJarByClass(UserReadHistoryDriver.class);
//
...
//        job.setNumReduceTasks(config.getParam("user_read_history_reduce_task_num", 10));
//
