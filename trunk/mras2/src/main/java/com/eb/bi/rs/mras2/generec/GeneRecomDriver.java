package com.eb.bi.rs.mras2.generec;
...
import com.eb.bi.rs.mras2.generec.category_pref.CategoryPrefMapper;
import com.eb.bi.rs.mras2.generec.category_pref.CategoryPrefReducer;
import com.eb.bi.rs.mras2.generec.gene_pref.GenePrefMapper;
import com.eb.bi.rs.mras2.generec.gene_pref.GenePrefReducer;
import com.eb.bi.rs.mras2.generec.pref_normalized.PrefNormalizedMapper;
import com.eb.bi.rs.mras2.generec.pref_normalized.PrefNormalizedReducer;
...
//			DistributedCache.addCacheFile(URI.create(status[i].getPath().toString()), conf);
            log.info("gene type file: " + status[i].getPath().toString() + " has been add into distributed cache");
        }
