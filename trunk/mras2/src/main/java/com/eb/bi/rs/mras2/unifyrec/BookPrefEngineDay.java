...
//        }
        ...
        Job job = Job.getInstance(conf, "unifyrec_prefengineincrement_user-pref-generator");
...
//			DistributedCache.addCacheFile(URI.create(status[i].getPath().toString()), conf);
        ...
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_user-read-classes");
        job.setJarByClass(BookPrefEngineDay.class);
        ...
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_user-read-history");
        job.setJarByClass(BookPrefEngineDay.class);
        ...
        job = Job.getInstance(conf,"unifyrec_prefengineincrement_user-class-pref");
...
//            System.out.println(fs[i].getPath().toString() + " has been add into distributedCache");
//        }
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_force-rec-class-pref");
...
//        }
        ...
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_comprehensive-pref-recommend");
...
//        }
        ...
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_man-pref-recommend");
...
//            System.out.println(fs[i].getPath().toString() + " has been add into distributedCache");
//        }
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_female-pref-recommend");
...
//        }
        ...
        job = Job.getInstance(conf, "unifyrec_prefengineincrement_publish-pref-recommend");
...
//			DistributedCache.addCacheFile(URI.create(status[i].getPath().toString()), conf);
        ...
        job =Job.getInstance(conf, "unifyrec_prefengineincrement_prefrec-result-merge");
        job.setJarByClass(BookPrefEngineDay.class);
