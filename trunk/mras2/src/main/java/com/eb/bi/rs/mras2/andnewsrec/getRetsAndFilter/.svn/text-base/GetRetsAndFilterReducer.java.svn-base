...
//        String title = newsTitleMap.get(newsID);
        ...
        for (Text value : values) {
            ...
            CompNews compNews = new CompNews(newsID2, score1, score2);
        ...
        ArrayList<CompNews> sortList = new ArrayList<CompNews>();
        for (Map.Entry<String, Double> entry : newsMap.entrySet()) {
            CompNews compNews = new CompNews(entry.getKey(), entry.getValue() /
