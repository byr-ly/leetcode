//package com.eb.bi.rs.mras2.unifyrec.SeparatePrefRecResult;
//
...
// */
//public class SeparatePrefRecResultDriver extends Configured implements Tool{
//
...
//
//        int ret = ToolRunner.run(new SeparatePrefRecResultDriver(), args);
...
//        String outputDir = config.getParam("separate_prefrec_result", "/user/hadoop/liujie/test/output/separate_prefrec_result");
...
//        }
//
//        Job job = new Job(conf, "separate-pref-recommend");
//        job.setJarByClass(SeparatePrefRecResultDriver.class);
//
//        //输入目录
