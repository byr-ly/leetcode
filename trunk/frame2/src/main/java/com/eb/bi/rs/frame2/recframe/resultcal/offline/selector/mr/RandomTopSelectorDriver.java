...
public class RandomTopSelectorDriver extends BaseDriver {
    ...
    public int run(String[] args) throws Exception {
        ...
        if ((value = properties.getProperty("random.base.field.indexes")) != null) {
            conf.set("random.base.field.indexes", value);
        }
        ...
        if ((value = properties.getProperty("max.or.min")) != null) {
            conf.set("max.or.min", value);
        }
        ...
        job.setMapperClass(RandomTopSelectorMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);

        job.setReducerClass(RandomTopSelectorReducer.class);
