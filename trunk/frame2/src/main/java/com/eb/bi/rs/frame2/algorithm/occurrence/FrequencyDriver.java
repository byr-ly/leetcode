...
public class FrequencyDriver extends Configured  implements Tool{
	...
	public FrequencyDriver(Logger log,String inputPath, String outputPath, Configuration conf, int reduceNum){
		m_log = log;
