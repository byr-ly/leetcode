...
public class DnaChaptCnt2HbaseTool extends BaseDriver {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "dnachaptcnt2hbase");

		job.setJarByClass(DnaChaptCnt2HbaseTool.class);
		job.setMapperClass(DnaChaptCnt2HbaseMapper.class);
		job.setReducerClass(DnaChaptCnt2HbaseReducer.class);
