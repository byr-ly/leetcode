 ...
 * 整体准确率计算
 */
public class TotalMAEDriver extends BaseDriver {
    ...
    public int run(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setJarByClass(TotalMAEDriver.class);
        ...
        MultipleInputs.addInputPath(job, new Path(dataInputPath), TextInputFormat.class, TotalMAEMapper.class);
        ...
        job.setCombinerClass(TotalMAECombiner.class);
        job.setNumReduceTasks(Integer.parseInt(reduceNum));
        job.setReducerClass(TotalMAEReducer.class);
