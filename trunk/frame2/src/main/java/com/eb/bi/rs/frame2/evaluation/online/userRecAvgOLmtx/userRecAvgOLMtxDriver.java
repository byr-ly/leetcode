 ...
 * 用户推荐位图书点击率 CTRu = Nuc / Nur 计算
 * 用户推荐位图书订购率OTRu = Nuo / Nur 计算
 * 用户推荐位转化率ConU = Nuo / Nuc 计算
 *
 * 参数：
 * Nuc：用户点击的推荐位图书数（去重）
 * Nuo：用户订购的推荐位图书数（去重）
 ...
 *
 */
public class userRecAvgOLMtxDriver extends BaseDriver {
    ...
    public int run(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setJarByClass(userRecAvgOLMtxDriver.class);
        ...
        MultipleInputs.addInputPath(job, new Path(dataNucInputPath), TextInputFormat.class, userRecNucMapper.class);
        ...
        MultipleInputs.addInputPath(job, new Path(dataNuoInputPath), TextInputFormat.class, userRecNuoMapper.class);
        ...
        MultipleInputs.addInputPath(job, new Path(dataNurInputPath), TextInputFormat.class, userRecNurMapper.class);
        ...
        job.setReducerClass(userRecAvgOLMtxReducer.class);
