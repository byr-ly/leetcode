...
public class StandardizeMapper extends Mapper<Object, Text, Text, NullWritable> {
    private static Logger log = Logger.getLogger("StandardizeMapper");
    ...
    public void setup(Context context) throws IOException, InterruptedException{
        ...
        standardize_type = String.valueOf(conf.get("standardize_type"));
...
//                    log.info("val.length:" + val.length);
                    ...
                    for (int i = 0; i < action_num; ++i) {
                        ...
                        arrMin[i] = Double.parseDouble(values[i+action_num]);
...
//                        log.info("arrMin[" + i + "]:" + arrMin[i]);
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException{
        ...
        for (int i = 0; i < fields.length - 1; ++i) {
            keyout.append(fields[i]).append("|");
        }
        keyout.append(fields[action_num + 1]);
