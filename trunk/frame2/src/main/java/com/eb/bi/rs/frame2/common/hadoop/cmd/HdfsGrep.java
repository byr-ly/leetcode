package com.eb.bi.rs.frame2.common.hadoop.cmd;
...
public class HdfsGrep extends Configured implements Tool {
    ...
    public static class grepMap extends
        ...
        public void map(LongWritable line, Text value, Mapper.Context context)
...
//        Job job = new Job(configuration, "grep");
        Job job = Job.getInstance(configuration, "grep");
