...
public class PersonalTailorTagTool extends BaseDriver {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "personalTailorTag2hbase");

		job.setJarByClass(PersonalTailorTagTool.class);
		job.setMapperClass(PersonalTailorTagMapper.class);
		job.setReducerClass(PersonalTailorTagReducer.class);
