...
public class FamousRecomTool extends BaseDriver {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "famousrecom2hbase");

		job.setJarByClass(FamousRecomTool.class);
		job.setMapperClass(FamousRecomMapper.class);
		job.setReducerClass(FamousRecomReducer.class);
