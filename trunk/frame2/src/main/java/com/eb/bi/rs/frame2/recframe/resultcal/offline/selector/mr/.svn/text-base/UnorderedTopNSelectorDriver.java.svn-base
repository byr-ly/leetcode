...
public class UnorderedTopNSelectorDriver extends BaseDriver {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(UnorderedTopNSelectorMapper.class);
        job.setCombinerClass(UnorderedTopNSelectorCombiner.class);
        job.setReducerClass(UnorderedTopNSelectorReducer.class);
